$(function () {
    ...
    function GetData() {
        ...
        $.ajax({
            ...
            data: '',
            dataType: "json",
            url: ajaxUrl + "PatchPanels/datagrid",
            success: function (data) {
                $.each(data.data, function (i, n) {
                    var aiNew = oTable02.fnAddData([n.id, n.name, n.portId, n.portName, n.portType, n.portConnect, n.engineRoom, n.cabinet,
    ...
    function DeleteData(oTable02, nRow) {
        ...
        $.ajax({
            ...
            dataType: "json",
            url: ajaxUrl + "PatchPanels/delete",
            success: function (data) {
                if (data.success) {
    ...
    $('#addRow').click(function (e) {
        window.location.href = "../pages/PatchPanelModify.html";
    });
    ...
    $(document).on("click", "#dataTables-example a.edit", function (e) {
        ...
        var nRow = $(this).parents('tr')[0];
        var aData = oTable02.fnGetData(nRow);
        window.location.href = "../pages/PatchPanelModify.html?id=" + aData[0];
    });
